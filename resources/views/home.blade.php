            ...
            <div>
                <form class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-200 rounded-lg bg-gray-50 focus:ring-gray-300 focus:border-gray-300 dark:bg-white-700 dark:border-gray-200 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-gray-300 dark:focus:border-gray-200" placeholder="Search Mockups, Logos..." required>
