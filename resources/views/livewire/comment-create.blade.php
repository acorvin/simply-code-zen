<div>
    <form x-data="{
        ...
        <div class="mb-4">
            <textarea wire:model="comment" @click="focused = true" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-lime-800 focus:ring-0" :rows="focused ? '4' : '1' " placeholder="Leave a comment"></textarea>
        </div>
